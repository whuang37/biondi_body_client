...
class Application():
    def __init__(self, master):
        ...
        self.screenshot = Toplevel(root)
        self.screenshot.withdraw()
        self.screenshot_frame = Frame(self.screenshot)
    ...
    def createScreenshotCanvas(self, img):
        self.screenshot.deiconify()
        root.withdraw()

        self.canvas1 = Canvas(self.screenshot_frame, width=img.width(), height = img.height(),borderwidth = 0, highlightthickness = 0 )
    ...
    def takeBoundedScreenShot(self, x1, y1, x2, y2):
        ...
        self.createScreenshotCanvas(img)
